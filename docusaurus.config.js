    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/devos-dev/api-docs/tree/main/packages/create-docusaurus/templates/shared/',
        },
        blog: {
          showReadingTime: true,
          // Please change this to your repo.
          editUrl:
            'https://github.com/devos-dev/api-docs/tree/main/packages/create-docusaurus/templates/shared/',
        },
        theme: {
